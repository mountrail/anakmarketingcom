    ...
    <div class="mt-24 px-6">
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div div class="mt-4">
                ...
                <x-select-input id="company_size" name="company_size" :options="['0-10', '11-50', '51-100', '101-500', '501++']" :selected="old('company_size')"
            ...
            <div div class="mt-4">
                ...
                <x-select-input id="city" name="city" :options="['Bandung', 'Jabodetabek', 'Jogjakarta', 'Makassar', 'Medan', 'Surabaya', 'Others']" :selected="old('city')" :placeholder="__('--Select City--')"
                    class="mt-1 block w-full" />
