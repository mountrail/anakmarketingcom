...
<div x-data="{
...
}" @keydown.escape.window="showModal = false; resetRegistrationForm()"
    ...
    <div x-cloak x-show="showModal"
        ...
        <!-- Modal Content -->
        <div @click.away="showModal = false; resetRegistrationForm()" x-show="showModal"
            ...
            <div class="flex text-center">
                <div @click="activeTab = 'register'; resetRegistrationForm();"
                ...
                <div @click="activeTab = 'login'; resetRegistrationForm();"
            ...
            <div class="p-6">
                <div x-show="activeTab === 'register'">
                    <!-- Registration Success Message (Now inside the register tab) -->
                    <div x-show="registrationSuccess" class="text-center">
                        ...
                        <button @click="showModal = false; resetRegistrationForm();"
                            ...
                            <div x-show="showRegisterForm || registrationStep === 2" class="mt-4">
                                ...
                                <form method="POST" action="{{ route('register') }}" id="register-form"
                                    @submit.prevent="if (registrationStep === 1) {
                                        ...
                                        isSubmitting = true;
                                        // Instead of submitting the form (which would redirect to login page),
                                        ...
                                        .then(response => {
                                            isSubmitting = false;
                                            if (response.ok) {
                                                // Show success message and stay on the same tab
                                    ...
                                    <div x-show="registrationStep === 1">
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <x-text-input id="register_password_confirmation"
                                                class="block mt-1 w-full" type="password"
                                                name="password_confirmation" required autocomplete="new-password" />
                                            <div id="password_confirmation-error"
                                                class="text-red-500 mt-1 text-sm hidden"></div>
                                    ...
                                    <div x-show="registrationStep === 2">
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <x-select-input id="register_seniority" name="seniority"
                                                :options="[
                                                    'Junior Staff',
                                                    'Senior Staff',
                                                    'Assistant Manager',
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <x-select-input id="register_company_size" name="company_size"
                                                :options="['0-10', '11-50', '51-100', '101-500', '501++']" :selected="old('company_size')" :placeholder="__('--Select Company Size--')"
                                                class="mt-1 block w-full" />
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <x-select-input id="register_city" name="city" :options="[
                                                'Bandung',
                                                'Jabodetabek',
                                                'Jogjakarta',
                                                'Makassar',
                                    ...
                                    <div class="flex items-center justify-end mt-4">
                                        ...
                                        <button type="submit"
                                            class="ms-4 bg-orange-500 hover:bg-orange-600 text-white font-bold py-2 px-4 rounded focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 inline-flex items-center"
                                            ...
                                            <span
                                                x-text="registrationStep === 1 ? 'Continue' : 'Register'">{{ __('Continue') }}</span>
                                        </button>
                                    </div>
                                </form>
                            </div>
