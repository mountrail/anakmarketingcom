    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-phone-input id="phone" name="phone"
                           :countryValue="isset($user->phone) && !empty($user->phone) ? ltrim(explode(' ', $user->phone)[0], '+') : ''"
                           :numberValue="isset($user->phone) && strpos($user->phone, ' ') !== false ? explode(' ', $user->phone)[1] : ''"/>
        </div>
        ...
        <div>
            ...
            <x-select-input id="company_size" name="company_size"
                            ...
                            :selected="old('company_size', $user->company_size)"
        ...
        <div>
            ...
            <x-select-input id="city" name="city"
                            ...
                            :selected="old('city', $user->city)" :placeholder="__('--Select City--')"
                            class="mt-1 block w-full"/>
