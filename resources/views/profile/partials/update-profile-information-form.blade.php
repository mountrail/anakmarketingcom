    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-select-input id="industry" name="industry" :options="[
                ...
                'Tech',
                'Others',
            ]" :selected="old('industry', $user->industry)"
        ...
        <div>
            ...
            <x-select-input id="seniority" name="seniority" :options="[
                ...
                'Owner',
                'Others',
            ]" :selected="old('seniority', $user->seniority)"
                class="mt-1 block w-full" />
        ...
        <div>
            ...
            <x-select-input id="city" name="city" :options="['Bandung', 'Jabodetabek', 'Jogjakarta', 'Makassar', 'Medan', 'Surabaya', 'Others']" :selected="old('city', $user->city)"
                class="mt-1 block w-full" />
