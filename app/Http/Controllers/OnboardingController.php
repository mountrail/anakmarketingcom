...
class OnboardingController extends Controller
{
    ...
    public function followUsers()
    {
        ...
        // If we have fewer than 3 users with posts, fill with random users without posts
        if ($usersWithPosts->count() < 3) {
            $remainingCount = 3 - $usersWithPosts->count();
            ...
            // Take only first 3 users with posts
            $recommendedUsers = $usersWithPosts->take(3);
        }
